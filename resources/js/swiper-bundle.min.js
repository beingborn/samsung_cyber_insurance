        ...
        return (
            z ||
                (z = (function ({ userAgent: e } = {}) {
                    ...
                    let h = 'MacIntel' === a;
                    return (
                        !c && h && t.touch && ['1024x1366', '1366x1024', '834x1194', '1194x834', '834x1112', '1112x834', '768x1024', '1024x768', '820x1180', '1180x820', '810x1080', '1080x810'].indexOf(`${l}x${o}`) >= 0 && ((c = i.match(/(Version)\/([\d.]+)/)), c || (c = [0, 1, '13_0_0']), (h = !1)),
    ...
    var H = {
        updateSize: function () {
            ...
            (t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : a.clientWidth),
                ...
                (0 === t && e.isHorizontal()) ||
                    (0 === s && e.isVertical()) ||
                    ((t = t - parseInt(y(a, 'padding-left') || 0, 10) - parseInt(y(a, 'padding-right') || 0, 10)), (s = s - parseInt(y(a, 'padding-top') || 0, 10) - parseInt(y(a, 'padding-bottom') || 0, 10)), Number.isNaN(t) && (t = 0), Number.isNaN(s) && (s = 0), Object.assign(e, { width: t, height: s, size: e.isHorizontal() ? t : s }));
        },
        updateSlides: function () {
            ...
            for (let a = 0; a < c; a += 1) {
                ...
                if (!i || (P && e.grid.updateSlide(a, i, d), 'none' !== y(i, 'display'))) {
                    ...
                    i && (i.swiperSlideSize = L),
                        h.push(L),
                        s.centeredSlides
                            ? ((S = S + L / 2 + M / 2 + x), 0 === M && 0 !== a && (S = S - E / 2 - x), 0 === a && (S = S - E / 2 - x), Math.abs(S) < 0.001 && (S = 0), s.roundLengths && (S = Math.floor(S)), C % s.slidesPerGroup === 0 && p.push(S), u.push(S))
                            : (s.roundLengths && (S = Math.floor(S)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup === 0 && p.push(S), u.push(S), (S = S + L + x)),
                        (e.virtualSize += L + x),
                        (M = L),
                        (C += 1);
                }
            ...
            if (
                (c !== o && e.emit('slidesLengthChange'), p.length !== w && (e.params.watchOverflow && e.checkOverflow(), e.emit('snapGridLengthChange')), u.length !== b && e.emit('slidesGridLengthChange'), s.watchSlidesProgress && e.updateSlidesOffset(), e.emit('slidesUpdated'), !(l || s.cssMode || ('slide' !== s.effect && 'fade' !== s.effect)))
            ) {
    ...
    var q = {
        ...
        loopFix: function ({ slideRealIndex: e, slideTo: t = !0, direction: s, setTranslate: a, activeSlideIndex: i, initial: r, byController: n, byMousewheel: l } = {}) {
            ...
            if (((o.allowSlidePrev = !0), (o.allowSlideNext = !0), o.virtual && m.virtual.enabled))
                return (
                    t && (b || 0 !== o.snapIndex ? (b && o.snapIndex < m.slidesPerView ? o.slideTo(o.virtual.slides.length + o.snapIndex, 0, !1, !0) : o.snapIndex === o.snapGrid.length - 1 && o.slideTo(o.virtual.slidesBefore, 0, !1, !0)) : o.slideTo(o.virtual.slides.length, 0, !1, !0)),
                    (o.allowSlidePrev = c),
                    (o.allowSlideNext = p),
                    void o.emit('loopFix')
                );
            ...
            d.length < y + x || ('cards' === o.params.effect && d.length < y + 2 * x)
                ? v('Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters')
            ...
            if (
                ...
                'cards' === o.params.effect && d.length < y + 2 * x && (M.includes(i) && M.splice(M.indexOf(i), 1), T.includes(i) && T.splice(T.indexOf(i), 1)),
                I &&
                    T.forEach((e) => {
            ...
            if (((o.allowSlidePrev = c), (o.allowSlideNext = p), o.controller && o.controller.control && !n)) {
                ...
                Array.isArray(o.controller.control)
                    ...
                    : o.controller.control instanceof o.constructor && o.controller.control.params.loop && o.controller.control.loopFix({ ...r, slideTo: o.controller.control.params.slidesPerView === m.slidesPerView && t });
            }
            o.emit('loopFix');
        },
            ...
            breakpoints: {
                setBreakpoint: function () {
                    ...
                    m && !h
                        ...
                        : !m && h && (r.classList.add(`${i.containerModifierClass}grid`), ((p.grid.fill && 'column' === p.grid.fill) || (!p.grid.fill && 'column' === i.grid.fill)) && r.classList.add(`${i.containerModifierClass}grid-column`), e.emitContainerClasses()),
    ...
    const we = [
        function ({ swiper: e, extendParams: t, on: s, emit: i }) {
            ...
            function d(t, s, a) {
                ...
                if ((d && y >= T ? ((M -= T), n || (P += e.slidesGrid[0])) : d && y < T && ((M = -T), n && (P += e.slidesGrid[0])), Object.assign(e.virtual, { from: M, to: C, offset: P, slidesGrid: e.slidesGrid, slidesBefore: T, slidesAfter: S }), h === M && f === C && !t))
                    return (
                        e.slidesGrid !== w &&
                            P !== b &&
                            e.slides.forEach((t) => {
            ...
            function o(t) {
                ...
                if (!(a.shiftKey || a.altKey || a.ctrlKey || a.metaKey || (n.activeElement && (n.activeElement.isContentEditable || (n.activeElement.nodeName && ('input' === n.activeElement.nodeName.toLowerCase() || 'textarea' === n.activeElement.nodeName.toLowerCase())))))) {
                    ...
                    e.isHorizontal()
                        ...
                        : ((d || c || m || h) && (a.preventDefault ? a.preventDefault() : (a.returnValue = !1)), (c || h) && e.slideNext(), (d || m) && e.slidePrev()),
                        i('keyPress', r);
                }
            }
            function d() {
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: a }) {
            ...
            function h(t) {
                return (
                    ...
                    ((t.delta >= 6 && o() - c < 60) || (t.direction < 0 ? (e.isEnd && !e.params.loop) || e.animating || (e.slideNext(), a('scroll', t.raw)) : (e.isBeginning && !e.params.loop) || e.animating || (e.slidePrev(), a('scroll', t.raw)), (c = new i.Date().getTime()), !1))
                );
            }
            function f(t) {
                let s = t,
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: a }) {
            ...
            function c() {
                ...
                if (
                    (e.params.loop ? ((d = e.previousRealIndex || 0), (i = e.params.slidesPerGroup > 1 ? Math.floor(e.realIndex / e.params.slidesPerGroup) : e.realIndex)) : void 0 !== e.snapIndex ? ((i = e.snapIndex), (d = e.previousSnapIndex)) : ((d = e.previousIndex || 0), (i = e.activeIndex || 0)),
            ...
            function u() {
                ...
                'string' == typeof t.el && e.isElement && (s = e.el.querySelector(t.el)),
                    ...
                    s &&
                        0 !== s.length &&
                        (e.params.uniqueNavElements && 'string' == typeof t.el && Array.isArray(s) && s.length > 1 && ((s = [...e.el.querySelectorAll(t.el)]), s.length > 1 && (s = s.find((t) => x(t, '.swiper')[0] === e.el))),
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: i }) {
            ...
            function f() {
                ...
                s ? ((o = -o), o > 0 ? ((l = d - o), (o = 0)) : -o + d > c && (l = c + o)) : o < 0 ? ((l = d + o), (o = 0)) : o + d > c && (l = c - o),
                    e.isHorizontal() ? ((a.style.transform = `translate3d(${o}px, 0, 0)`), (a.style.width = `${l}px`)) : ((a.style.transform = `translate3d(0px, ${o}px, 0)`), (a.style.height = `${l}px`)),
                    r.hide &&
                        (clearTimeout(m),
                        (i.style.opacity = 1),
                        (m = setTimeout(() => {
            ...
            function C() {
                ...
                e.params.uniqueNavElements && 'string' == typeof a.el && i.length > 1 && 1 === s.querySelectorAll(a.el).length && (i = s.querySelector(a.el)),
                    ...
                    i && ((l = i.querySelector(oe(e.params.scrollbar.dragClass))), l || ((l = w('div', e.params.scrollbar.dragClass)), i.append(l))),
        ...
        function ({ swiper: e, extendParams: t, on: s, emit: a }) {
            ...
            function P(t) {
                ...
                i >= 0 && (m[i] = t),
                    m.length < 2 ||
                        ((l = !0),
                        (h.scaleMove = E()),
                        h.imageEl && ((a.scale = (h.scaleMove / h.scaleStart) * o), a.scale > h.maxRatio && (a.scale = h.maxRatio - 1 + (a.scale - h.maxRatio + 1) ** 0.5), a.scale < s.minRatio && (a.scale = s.minRatio + 1 - (s.minRatio - a.scale + 1) ** 0.5), (h.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`)));
            }
            function L(t) {
                if (!T(t)) return;
            ...
            function I(t) {
                ...
                if ((Math.max(Math.abs(f.touchesCurrent.x - f.touchesStart.x), Math.abs(f.touchesCurrent.y - f.touchesStart.y)) > 5 && (e.allowClick = !1), !f.isMoved && !c)) {
                    if (e.isHorizontal() && ((Math.floor(f.minX) === Math.floor(f.startX) && f.touchesCurrent.x < f.touchesStart.x) || (Math.floor(f.maxX) === Math.floor(f.startX) && f.touchesCurrent.x > f.touchesStart.x))) return (f.isTouched = !1), void z();
                    if (!e.isHorizontal() && ((Math.floor(f.minY) === Math.floor(f.startY) && f.touchesCurrent.y < f.touchesStart.y) || (Math.floor(f.maxY) === Math.floor(f.startY) && f.touchesCurrent.y > f.touchesStart.y))) return (f.isTouched = !1), void z();
                }
                ...
                (s.scale = A || $),
                    ...
                    !t || (1 === o && A)
                        ...
                        : ((L = h.slideEl.offsetWidth),
                          ...
                          (C = -T),
                          (P = -M),
                          I > 0 && A && 'number' == typeof f.currentX && 'number' == typeof f.currentY ? ((u = (f.currentX * s.scale) / I), (m = (f.currentY * s.scale) / I)) : ((u = c * s.scale), (m = p * s.scale)),
                          u < T && (u = T),
                          u > C && (u = C),
                          m < M && (m = M),
                          m > P && (m = P)),
                    ...
                    setTranslate: function (t, s) {
                        ...
                        function o(t) {
                            ...
                            'slide' === e.params.controller.by &&
                                ...
                                (n && 'container' !== e.params.controller.by) || ((r = (t.maxTranslate() - t.minTranslate()) / (e.maxTranslate() - e.minTranslate())), (!Number.isNaN(r) && Number.isFinite(r)) || (r = 1), (n = (s - e.minTranslate()) * r + t.minTranslate())),
        ...
        function ({ swiper: e, extendParams: t, on: s }) {
            ...
            s('init', () => {
                ...
                s('update', () => {
                    ...
                    n && !a ? (s.classList.remove(`${t.containerModifierClass}grid`, `${t.containerModifierClass}grid-column`), (r = 1), e.emitContainerClasses()) : !n && a && (s.classList.add(`${t.containerModifierClass}grid`), 'column' === t.grid.fill && s.classList.add(`${t.containerModifierClass}grid-column`), e.emitContainerClasses()),
                        (n = a);
                }),
                (e.grid = {
                    initSlides: (t) => {
        ...
        function ({ swiper: e }) {
            Object.assign(e, { appendSlide: de.bind(e), prependSlide: ce.bind(e), addSlide: pe.bind(e), removeSlide: ue.bind(e), removeAllSlides: me.bind(e) });
        },
        function ({ swiper: e, extendParams: t, on: s }) {
