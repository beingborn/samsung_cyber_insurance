                ...
                if (p) {
                    if (m !== this._tTime || !t || r || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 != _)) {
                        ...
                        (l && l.render(t < 0 ? t : l._dur * l._ease(i / this._dur), e, r)) || (this._startAt && (this._zTime = t)),
                            ...
                            (m !== this._tDur && m) ||
                                this._tTime !== m ||
                                (_ && !this._onUpdate && Ca(this, t, 0, !0), (!t && p) || !((m === this._tDur && 0 < this._ts) || (!m && this._ts < 0)) || za(this, 1), e || (_ && !d) || !(m || d || u) || (Ct(this, m === c ? 'onComplete' : 'onReverseComplete', !0), !this._prom || (m < c && 0 < this.timeScale()) || this._prom()));
                    }
                } else
    ...
    function ke(t, e) {
        ...
        return s.svg && t.getAttribute('transform')
            ? '1,0,0,1,0,0' === (u = [(n = t.transform.baseVal.consolidate().matrix).a, n.b, n.c, n.d, n.e, n.f]).join(',')
                ? wr
                : u
            : (u !== wr || t.offsetParent || t === Re || s.svg || ((n = o.display), (o.display = 'block'), ((r = t.parentNode) && t.offsetParent) || ((a = 1), (i = t.nextElementSibling), Re.appendChild(t)), (u = je(t)), n ? (o.display = n) : Xd(t, 'display'), a && (i ? r.insertBefore(t, i) : r ? r.appendChild(t) : Re.removeChild(t))),
    ...
    var Ee,
        ...
        yr = function _get(t, e, r, i) {
            ...
            return (
                ...
                ar[e] && 'transform' !== e ? ((n = Or(t, i)), (n = 'transformOrigin' !== e ? n[e] : n.svg ? n.origin : kr(Pd(t, pr)) + ' ' + n.zOrigin + 'px')) : ((n = t.style[e]) && 'auto' !== n && !i && !~(n + '').indexOf('calc(')) || (n = (br[e] && br[e](t, e, r)) || Pd(t, e) || ga(t, e) || ('opacity' === e ? 1 : 0)),
            ...
            return (
                ...
                B.translate &&
                    (('none' === B.translate && 'none' === B.scale && 'none' === B.rotate) ||
                        (F[cr] = ('none' !== B.translate ? 'translate3d(' + (B.translate + ' 0 0').split(' ').slice(0, 3).join(', ') + ') ' : '') + ('none' !== B.rotate ? 'rotate(' + B.rotate + ') ' : '') + ('none' !== B.scale ? 'scale(' + B.scale.split(' ').join(',') + ') ' : '') + ('none' !== B[cr] ? B[cr] : '')),
        ...
        zr = function _renderSVGTransforms(t, e) {
            ...
            (d = parseFloat(d)),
                ...
                d || c
                    ? ((d *= or), (c *= or), (r = Math.cos(d) * _), (i = Math.sin(d) * _), (n = Math.sin(d - c) * -m), (a = Math.cos(d - c) * m), c && ((p *= or), (s = Math.tan(c - p)), (n *= s = Math.sqrt(1 + s * s)), (a *= s), p && ((s = Math.tan(p)), (r *= s = Math.sqrt(1 + s * s)), (i *= s))), (r = ia(r)), (i = ia(i)), (n = ia(n)), (a = ia(a)))
                    : ((r = _), (a = m), (i = n = 0)),
                    ...
                    if ('autoRound' !== d && ((o = e[d]), !pt[d] || !ac(d, e, i, n, t, a)))
                        if (((l = typeof o), (f = br[d]), 'function' === l && (l = typeof (o = o.call(i, n, t, a))), 'string' === l && ~o.indexOf('random(') && (o = ob(o)), f)) f(this, t, d, o, i) && (T = 1);
                            ...
                            if (
                                ...
                                (u = parseFloat(o)),
                                d in dr && ('autoAlpha' === d && (1 === h && 'hidden' === yr(t, 'visibility') && u && (h = 0), b.push('visibility', 0, x.visibility), Yd(this, x, 'visibility', h ? 'inherit' : 'hidden', u ? 'inherit' : 'hidden', !u)), 'scale' !== d && 'transform' !== d && ~(d = dr[d]).indexOf(',') && (d = d.split(',')[0])),
                                (m = d in ar))
                            )
