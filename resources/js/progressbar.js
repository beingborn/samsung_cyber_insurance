                                                ...
                                                (e = [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        value: function () {
                                                            ...
                                                            return null === this._timestamp
                                                                ...
                                                                : this._isPlaying
                                                                ? this._promise
                                                                : (this._pausedAtTime && ((this._timestamp += n - this._pausedAtTime), (this._pausedAtTime = null)), (this._isPlaying = !0), null === ht ? ((ht = this), (pt = this)) : ((this._previous = pt), (pt._next = this), (pt = this)), this);
                                                        },
                                                    },
                                                    {
                                                        key: 'seek',
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        value: function () {
                                                            ...
                                                            return (
                                                                t && (n && this._applyFilter(ut), yt(1, this._currentState, this._originalState, this._targetState, 1, 0, this._easing), n && (this._applyFilter(it), this._applyFilter(ot))),
